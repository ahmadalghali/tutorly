...
function login () {
  if (email.value.trim() === '' || password.value.trim() === '') return console.log('Email or password cannot be empty');
...
<template>
  <div class>
    <div class="grid justify-items-center">
      ...
      <button class="btn w-full bg-primary h-12 mt-14 text-gray-800" @click="login">Login</button>
