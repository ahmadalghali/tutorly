<template>
  ...
  >
    <div class="flex p-4">
      <font-awesome-icon
        icon="arrow-left"
        class="text-left text-gray-800 text-3xl"
        @click="$router.go(-1)"
      />
      <div class="text-center text-2xl ml-5">John Doe</div>
    </div>
    <div
      class="flex flex-col px-4 h-4/6 overflow-scroll mb-auto overscroll-auto space-y-5 bg-green-200"
      ref="chatContainer"
    >
      <Message
    ...
    <div class="flex items-center">
      ...
      <div class="w-1/6">
        <div
          class="flex flex-wrap justify-center content-center rounded-full bg-blue-500 h-12 w-12 pr-1"
        >
          <font-awesome-icon
            icon="paper-plane"
